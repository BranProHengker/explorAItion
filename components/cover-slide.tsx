  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center px-6 py-8 relative overflow-hidden bg-background">
      ...
      <div className="relative z-10 text-center max-w-5xl flex flex-col items-center justify-center h-full">
        ...
        {/* Logo Badge */}
        <div className="inline-flex items-center justify-center gap-2 mb-6 px-4 py-2 rounded-full bg-white border border-slate-200 shadow-sm shrink-0">
           <ShieldCheck className="w-5 h-5 text-primary" />
           <span className="text-xs font-bold tracking-widest uppercase text-slate-600">Official Pitch Deck</span>
        </div>
        ...
        <div className="bg-white border border-slate-200 shadow-xl shadow-slate-200/50 rounded-2xl p-6 md:p-8 max-w-3xl mx-auto mb-10 relative shrink-0">
          ...
          <p className="text-base md:text-lg leading-relaxed text-slate-700">
            ...
            <span className="text-primary font-bold text-xl align-middle ml-2 underline decoration-primary/20 decoration-4 underline-offset-4">Rp 500 juta</span>."
          </p>
        </div>
