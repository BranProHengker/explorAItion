...
export function SolutionSlide() {
  const features = [
    ...
    { 
      ...
      description: "Serangan terdeteksi? Kami langsung blokir dan pulihkan akses sebelum Anda sadar." 
    },
    { 
      icon: Banknote, 
      title: "Garansi Rp 500 Juta", 
      description: "Satu-satunya yang berani ganti rugi finansial jika sistem kami gagal melindungi Anda." 
    },
  ]
      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white border border-slate-200 rounded-2xl p-8 text-left hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden"
            >
              ...
              <div className="inline-flex p-4 bg-primary/10 rounded-xl mb-6 group-hover:bg-primary/20 transition-colors relative z-10">
        ...
        <div className="bg-slate-900 rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
          ...
          <Moon className="w-16 h-16 mx-auto mb-8 text-primary/80 relative z-10" />
          <p className="text-2xl md:text-4xl font-bold leading-tight text-white relative z-10 font-serif italic">
            &quot;Tidur nyenyak.<br className="hidden md:block" /> Besok bangun, tokomu masih ada.&quot;
          </p>
        </div>
      </div>
    </div>
